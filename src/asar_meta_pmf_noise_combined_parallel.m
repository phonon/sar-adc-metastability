function [ err_range, pmf, err_folded, err_pmf_folded ] = asar_meta_pmf_noise_combined_parallel(B, VRESET, TIMING, STDCOMP, varargin)
% Same as asar_meta_pmf_noise_combined.m but uses parfor to parallize.
...
%             ft_vid{n+1}{2*b}{k} = zeros(length(VLSB_VFS_RANGE), NPOINTS_T);
            ...
            % 2nd+ cycles, parallelize convolutions
                ...
                parfor i = 1:length(VLSB_VFS_RANGE)
...
err_pmf_folded = pmf(index0:end) + [0, fliplr(pmf(1:index0-1))];
