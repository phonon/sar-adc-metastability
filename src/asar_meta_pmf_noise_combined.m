function [ err_range, pmf, err_folded, err_pmf_folded ] = asar_meta_pmf_noise_combined(B, VRESET, TIMING, STDCOMP, varargin)
% Calculates ASAR error PMF that combines ideal timing errors and thermal noise
